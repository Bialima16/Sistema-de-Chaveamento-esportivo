-- Atualização oficial do Vôlei 4x4 Misto: Grupo A com 4 equipes,
-- Grupo B com 5 equipes, 16 jogos, semifinais e final.
begin;
update public.competitions set format='9 equipes · 2 grupos',advance_rule='2 melhores de cada grupo avançam para as semifinais' where id='v4x';
...
('v4b-5','v4x','v4b','Raylson, Renan, Ana Clara e Letícia','',5)
...
('v4b-5','v4x','Raylson',1),('v4b-5','v4x','Renan',2),('v4b-5','v4x','Ana Clara',3),('v4b-5','v4x','Letícia',4);
...
('v4x-g-7','v4x','v4b','Grupos',7,'v4b-1','v4b-5'),
('v4x-g-8','v4x','v4b','Grupos',8,'v4b-2','v4b-4'),
('v4x-g-9','v4x','v4b','Grupos',9,'v4b-1','v4b-3'),
('v4x-g-10','v4x','v4b','Grupos',10,'v4b-5','v4b-2'),
('v4x-g-11','v4x','v4b','Grupos',11,'v4b-1','v4b-4'),
('v4x-g-12','v4x','v4b','Grupos',12,'v4b-3','v4b-5'),
('v4x-g-13','v4x','v4b','Grupos',13,'v4b-1','v4b-2'),
('v4x-g-14','v4x','v4b','Grupos',14,'v4b-4','v4b-3'),
('v4x-g-15','v4x','v4b','Grupos',15,'v4b-2','v4b-3'),
('v4x-g-16','v4x','v4b','Grupos',16,'v4b-4','v4b-5');
